...
parser.add_argument('-ip', '--inferencing_percent', type=float, default=0.05, help='percentage of the data for testing/inferencing')
...
plot_dir_path = f'{logs_dirpath}/plots_inferences'
