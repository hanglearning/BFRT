...
Please refer to [CCGrid '22](https://fcrlab.unime.it/ccgrid22/) [*Paper Unpublished*](https://drive.google.com/file/d/1FaNv0KYo1u_8xlFvdrRvgZJi_lM5Fmmz/view?usp=sharing) for detailed explanations and the algorithms.
...
4. `-ml`  "ml" denotes "max data length", which refers to the `MaxDataSize` in Algorithm 2 [of the paper](https://drive.google.com/file/d/1FaNv0KYo1u_8xlFvdrRvgZJi_lM5Fmmz/view?usp=sharing).
...
| -il | int |  12| Input length for the LSTM/GRU network. See `input_shape` in Algorithm 4 [in the paper](https://drive.google.com/file/d/1FaNv0KYo1u_8xlFvdrRvgZJi_lM5Fmmz/view?usp=sharing). |
...
| -dp | str |  '/content/drive/MyDrive/traffic_data/'| Dataset path |
| -tp | float |  1.0 | percentage of the data used for learning (we used 0.8 in our experiments, see footnote in Page 5 of [the paper](https://drive.google.com/file/d/1FaNv0KYo1u_8xlFvdrRvgZJi_lM5Fmmz/view?usp=sharing)) |
...
| -ml | int |  24| Maximum data length for training in each communication round, simulating the memory space a sensor has. See `MaxDataSize` in Algorithm 2 [in the paper](https://drive.google.com/file/d/1FaNv0KYo1u_8xlFvdrRvgZJi_lM5Fmmz/view?usp=sharing). |
